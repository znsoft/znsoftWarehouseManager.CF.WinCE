...
{
    partial class ФормаВыборТТНТерминал
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "ФормаВыборТТНТерминал";
            this.TopMost = true;
            this.Load += new System.EventHandler(this.ФормаВыборТТНТерминал_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.ФормаВыборТТНТерминал_KeyDown);
