...
{
    partial class ФормаВыборФилиалаТерминал
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "ФормаВыборФилиалаТерминал";
            this.TopMost = true;
            this.Load += new System.EventHandler(this.ФормаВыборФилиалаТерминал_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.ФормаВыборФилиалаТерминал_KeyDown);
