...
{
    partial class ОкноПеремещенияСписка
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "Выбор";
            this.TopMost = true;
            this.Load += new System.EventHandler(this.ОкноПеремещенияСписка_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.ОкноПеремещенияСписка_KeyDown);
