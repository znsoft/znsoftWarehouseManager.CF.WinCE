...
{
    partial class ОкноНабораАдреса
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Назад.Location = new System.Drawing.Point(7, 280);
            ...
            this.Name = "ОкноНабораАдреса";
            this.Text = "Выбор динамической ячейки подбора";
            this.TopMost = true;
            this.Load += new System.EventHandler(this.ОкноНабораАдреса_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.ОкноНабораАдреса_KeyDown);
