...
{
    partial class ОкноПодтоваркиТоваров
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.СписокПодтоварки = new System.Windows.Forms.ListView();
            ...
            // СписокПодтоварки
            // 
            this.СписокПодтоварки.Activation = System.Windows.Forms.ItemActivation.TwoClick;
            this.СписокПодтоварки.Columns.Add(this.КолонкаТовар);
            this.СписокПодтоварки.Columns.Add(this.КолонкаКод);
            this.СписокПодтоварки.Columns.Add(this.КолонкаГуид);
            this.СписокПодтоварки.Columns.Add(this.КолонкаКоличество);
            this.СписокПодтоварки.Columns.Add(this.КолонкаАдрес);
            this.СписокПодтоварки.Font = new System.Drawing.Font("Tahoma", 9F, System.Drawing.FontStyle.Regular);
            this.СписокПодтоварки.FullRowSelect = true;
            this.СписокПодтоварки.Location = new System.Drawing.Point(0, 0);
            this.СписокПодтоварки.Name = "СписокПодтоварки";
            this.СписокПодтоварки.Size = new System.Drawing.Size(234, 170);
            this.СписокПодтоварки.TabIndex = 1;
            this.СписокПодтоварки.Tag = "Таблица";
            this.СписокПодтоварки.View = System.Windows.Forms.View.Details;
            this.СписокПодтоварки.SelectedIndexChanged += new System.EventHandler(this.СписокПеремещения_SelectedIndexChanged);
            // 
            // КолонкаТовар
            // 
            this.КолонкаТовар.Text = "Товар";
            this.КолонкаТовар.Width = 70;
            // 
            // КолонкаКод
            // 
            ...
            this.ДопИнфо.Location = new System.Drawing.Point(0, 170);
            this.ДопИнфо.Name = "ДопИнфо";
            this.ДопИнфо.Size = new System.Drawing.Size(234, 65);
            ...
            this.Панель_ОсновногоМеню.Controls.Add(this.СписокПодтоварки);
            ...
            this.Name = "ОкноПодтоваркиТоваров";
            this.Text = "Выбор";
            this.TopMost = true;
            this.Load += new System.EventHandler(this.ОкноПодтоваркиТоваров_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.ОкноПодтоваркиТоваров_KeyDown);
        ...
        public System.Windows.Forms.ListView СписокПодтоварки;
