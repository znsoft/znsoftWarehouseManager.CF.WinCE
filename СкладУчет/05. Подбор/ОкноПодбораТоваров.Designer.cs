namespace СкладскойУчет
{
    partial class ОкноПодбораТоваров
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ПредставлениеТовара = new System.Windows.Forms.ColumnHeader();
            ...
            this.СписокВыбора.Columns.Add(this.ПредставлениеТовара);
            ...
            // ПредставлениеТовара
            // 
            this.ПредставлениеТовара.Text = "";
            this.ПредставлениеТовара.Width = 0;
            // 
            // МенюПодбора
            // 
        ...
        private System.Windows.Forms.ColumnHeader ПредставлениеТовара;
