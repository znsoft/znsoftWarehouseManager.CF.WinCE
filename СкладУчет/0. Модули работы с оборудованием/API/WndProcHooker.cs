...
namespace СкладскойУчет
{
    class WndProcHooker
    {
                ...
                Control ctl, WndProcCallback callback, uint msg)
            {
                ...
                if (hpi == null)
                {
                    ...
                    hpi = new HookedProcInformation(ctl,
                        new WinApi.WndProc(WndProcHooker.WindowProc));
            ...
            class HookedProcInformation
            {
                ...
                /// wndproc.
                /// </summary>
                private WinApi.WndProc newWndProc;
                ...
                public void SetHook()
                {
                    ...
                    oldWndProc = WinApi.SetWindowLong(hwnd, WinApi.GWL_WNDPROC,
                ...
                public void Unhook()
                {
                    ...
                    WinApi.SetWindowLong(hwnd, WinApi.GWL_WNDPROC, oldWndProc);
                }
